...
public class ProdottoDao implements ProdottoDaoInterfaccia{
    ...
    // Lista bianca dei nomi delle colonne
    private static final List<String> validColumns = Arrays.asList("NOME", "PIATTAFORMA", "DESCRIZIONE", "PREZZO", "QUANTITA", "GENERE", "DATA_USCITA", "IN_VENDITA", "IVA", "IMMAGINE", "DESCRIZIONE_DETTAGLIATA");
    ...
    public synchronized ArrayList<ProdottoBean> doRetrieveAll(String order) throws SQLException {
        ...
        if (order != null && !order.equals("") && validColumns.contains(order)) {
            ...
            selectSQL += " ORDER BY NOME"; // Ordine di default
        }
